...
public class VersCommand extends FlyguyCommand
{
    ...
    public VersCommand(String command, String permission, ArrayList<FlyguyCommand> subCommands, PingAnimationSave anim, PingAnimationConfig config)
    {
