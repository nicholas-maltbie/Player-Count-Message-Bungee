...
public class PlayCommand extends FlyguyCommand
{
    ...
    public PlayCommand(String command, String permissoin, ArrayList<FlyguyCommand> subCommands, PingAnimationSave anim, PingAnimationConfig config)
    {
        super(command, permissoin, subCommands);
        this.config = config;
        this.anim = anim;
    }
