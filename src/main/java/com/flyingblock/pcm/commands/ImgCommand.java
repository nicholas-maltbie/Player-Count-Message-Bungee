...
public class ImgCommand extends FlyguyCommand
{
    ...
    public static final String[] HELP_PCM_MESSAGE2 = {
        ...
        "  &6/pcm img set name [text] &4|&r sets the image file to [text] (include file extension)",
    ...
    public ImgCommand(String command, String permission, ArrayList<FlyguyCommand> subCommands, PingAnimationSave anim, PingAnimationConfig config)
    {
